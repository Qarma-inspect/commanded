...
There is also an [in-memory event store adapter](`Commanded.EventStore.Adapters.InMemory`). This provides no persistence and is intended for unit testing and local development only.
